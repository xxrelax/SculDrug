...
from core.datasets.parsers.protein_parser import PDBProteinFA
...
class InteractionAnalyzer(object):
    ...
    def plip_analysis(self, out_dir):
        ...
        command = 'python /root/project/bfn_mol/core/tools/plip/plip/plipcmd.py -f {pdb_file} -o {out_dir} -x'.format(pdb_file=self.merged_pdb_file_path,
                                                              out_dir = out_dir_tmp)
